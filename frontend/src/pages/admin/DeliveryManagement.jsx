...
export default function DeliveryManagement() {
  ...
  const filteredDeliveries = deliveryPartners.filter((delivery) => {
    ...
    return (
      removeAccents(delivery.manager.toLowerCase()).includes(search) ||
      removeAccents(delivery.email.toLowerCase()).includes(search) ||
      removeAccents(delivery.phone.toLowerCase()).includes(search) ||
      removeAccents(delivery.vehicleType.toLowerCase()).includes(search) ||
      removeAccents(delivery.licensePlate.toLowerCase()).includes(search)
    )
  })
      ...
      <div className="delivery-page">
        ...
        <div className="delivery-toolbar">
          ...
          <div className="delivery-search-wrapper">
            <svg className="delivery-search-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
