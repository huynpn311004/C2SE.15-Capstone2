...
class InventoryLot(Base):
    ...
    __table_args__ = (UniqueConstraint("store_id", "lot_code", name="uq_store_lot"), Index("idx_expiry", "expiry_date"))
    ...
    qty_disposed: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    qty_imported: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
