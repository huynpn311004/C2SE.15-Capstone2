...
const seedPermissions = [
  { id: 1, staffName: 'Nguyễn Văn A', role: 'Staff', permissions: ['inventory.view', 'inventory.edit', 'orders.view'], store: 'BigMart Q1' },
  { id: 2, staffName: 'Trần Thị B', role: 'Senior Staff', permissions: ['inventory.view', 'inventory.edit', 'inventory.delete', 'orders.view', 'orders.update', 'donations.view'], store: 'BigMart Q1' },
  { id: 3, staffName: 'Lê Văn C', role: 'Supervisor', permissions: ['inventory.view', 'inventory.edit', 'inventory.delete', 'orders.view', 'orders.update', 'donations.view', 'donations.approve', 'reports.view'], store: 'BigMart Q3' },
  { id: 4, staffName: 'Phạm Thị D', role: 'Staff', permissions: ['inventory.view', 'orders.view', 'orders.update'], store: 'BigMart Q5' },
]
...
export default function PermissionsManagement() {
  const [data, setData] = useState(seedPermissions)
  ...
  return (
    <div className="saperm-page">
      ...
      <div className="saperm-toolbar">
        <div className="saperm-toolbar-info">Hiển thị {data.length} nhân viên</div>
      </div>
